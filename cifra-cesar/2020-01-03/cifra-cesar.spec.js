...
describe('algoritmo cifra cesar',function(){
    ...
    it('chamada da funcao cifrar com a palavra "a vaca" deve retornar "a vaca"',function(){
        const entrada = "a vaca"
        const retorno = "d ydfd"

        const stringCifrada = CifraCesar.cifrar(entrada)

        expect(stringCifrada).toEqual(retorno)
    })
    it('cifrando a frase "a ligeira raposa marrom saltou sobre o cachorro cansado"  ', function(){
        const entrada = "a ligeira raposa marrom saltou sobre o cachorro cansado"
        const retorno = "d oljhlud udsrvd pduurp vdowrx vreuh r fdfkruur fdqvdgr"
